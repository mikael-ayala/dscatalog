...
public class UserController {
    ...
    @PostMapping
    private ResponseEntity<UserDTO> insert(@RequestBody UserInsertDTO userInsertDTO) {
    ...
    @PutMapping("/{id}")
    private ResponseEntity<UserDTO> update(@PathVariable Long id, @RequestBody UserDTO userDTO) {
